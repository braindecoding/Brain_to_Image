...
from models.eeggan import (build_discriminator, build_EEGgan, build_MoGgenerator,
...
generator = build_MoGgenerator(eeg_encoding_dim,1,len(class_labels))
...
for epoch in range(epochs+1):
    ...
    if epoch % save_interval == 0 or epoch == epochs:
        save_model(generator, f"MoGC_EEG_Generator_{epoch}")
        save_model(discriminator, f"MoGC_EEG_Discriminator_{epoch}")
...
with open(f"./brain_to_image/EEGgan/EEG_saved_model/MoGC_EEG_history.pkl","wb") as f:
    pickle.dump(history,f)
combined.save_weights(f"./brain_to_image/EEGgan/EEG_saved_model/MoGC_EEGGan_combined_weights.h5")
generator.save_weights(f"./brain_to_image/EEGgan/EEG_saved_model/MoGC_EEGGan_generator_weights.h5")
discriminator.save_weights(f"./brain_to_image/EEGgan/EEG_saved_model/MoGC_EEGGan_discriminator_weights.h5")
